...
workbuddy clones the repo into `~/.workbuddy/skills/webclaw3`, starts the local services, and guides you through the one-time [wc3-chrome](https://github.com/fatmind/wc3-chrome) extension setup if needed.
