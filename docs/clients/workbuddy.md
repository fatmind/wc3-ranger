...
**1. Install** — clone into workbuddy's skills directory:

```bash
git clone git@github.com:fatmind/wc3-ranger.git ~/.workbuddy/skills/webclaw3
```

**2. Check the environment** — in workbuddy, say:
